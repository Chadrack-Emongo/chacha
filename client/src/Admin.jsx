                    ...
                    <div className='flex justify-center p-5 bg-slate-800 w-2/4 rounded-2xl'>
                        ...
                        <div className="mt-5">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="grid">
                                    <label className="text-white text-white mt-6 font-bold" htmlFor="Téléphone">Téléphone</label>
                                ...
                                <div className="grid">
                                    <label className="text-white text-white mt-6 font-bold" htmlFor="Email">Email</label>
                                ...
                                <div className="grid">
                                    <label className="text-white text-white mt-6 font-bold" htmlFor="username">Username</label>
                                ...
                                <div className="grid">
                                    <label className="text-white text-white mt-6 font-bold" htmlFor="password">Password</label>
                                    <input className='w-96 mt-2 p-3 rounded-xl h-12 text-black font-bold border border-red-400' type="password" name="password" value={formData.password} onChange={handleChange} placeholder="Votre mot de passe" />
                                </div>
                                <div className="grid">
