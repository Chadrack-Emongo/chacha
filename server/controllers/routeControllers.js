...
// createAdmin
const createAdmin = await createAdmin.Prisma.create({
    data:{
      name: req.body.name,
      lastName: req.body.lastName,
      phone: req.body.phone,
...
// readAdmin
const readAdmin = await 
readAdmin.Prisma.read({
})

// updateAdmin
const updateAdmin = await updateAdmin.Prisma.update({
  where: {
    id: req.params.id
  },
  data: {
...
// deleteAdmin
const deleteAdmin = await deleteAdmin.Prisma.delete({
  where: {
    id: req.params.id
  }
})
